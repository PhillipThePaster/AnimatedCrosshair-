...
local library = {
    ...
    changed = {},
    folders = {
        main = "AnimatedCrosshair",
        assets = "AnimatedCrosshair/assets",
        configs = "AnimatedCrosshair/configs"
    },
    shared = {
        initialized = false,
        fps = 0,
...
do
    ...
    function library:New(info)
		local info = info or {}
        local name = info.name or info.Name or info.title or info.Title or "AnimatedCrosshair"
        ...
        function window:Watermark(info)
            ...
            --
            local info = info or {}
            local watermark_name = info.name or info.Name or info.title or info.Title or string.format("AnimatedCrosshair || ping : %u || fps : %u", 1, 0, 0)
            --
            ...
            local watermark_title = utility:Create("TextLabel", {Vector2.new(2 + 6,4), watermark_outline}, {
                Text = string.format("AnimatedCrosshair || fps : %u ||", 35, 1),
                Size = theme.textsize,
                Font = theme.font,
                Color = theme.textcolor,
                OutlineColor = theme.textborder,
            ...
            --
            watermark_title.Text = string.format("[Tryhit.me || ping : %i || fps : %u", 1, tostring(library.shared.ping), library.shared.fps)
...
-- // Init
do
    local title_string = "Animated Crosshair| %A, %B"
